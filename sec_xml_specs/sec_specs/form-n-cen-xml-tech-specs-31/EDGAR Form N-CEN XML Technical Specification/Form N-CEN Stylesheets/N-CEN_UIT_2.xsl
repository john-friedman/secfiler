			...
			<table role="presentation">
				<tr>
					...
					<tr>
						...
						<td>
							<div class="fakeBox2">
								<xsl:value-of select="string(m1:depositorRssdId)" />
								<span>
									<xsl:text>&#160;</xsl:text>
								</span>
							</div>
		...
		<xsl:choose>
			<xsl:when
				...
				<table role="presentation">
					...
					<tr>
						<td class="label">
							v. Is the administrator an affiliated person of the Fund or depositor?
						</td>
						<td>
		...
		<xsl:for-each select="m1:unitInvestmentTrust/m1:uitAdmins/m1:uitAdmin">
			<table role="presentation">
				...
				<tr>
					...
					<td>
						<div class="fakeBox">
							<xsl:value-of select="string(m1:uitAdminRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
				...
				<tr>
					...
					<td>
						<div class="fakeBox3">
							<xsl:value-of select="string(m1:uitAdminOther)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
		...
		<xsl:for-each
			...
			<table role="presentation">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:sponsorRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
