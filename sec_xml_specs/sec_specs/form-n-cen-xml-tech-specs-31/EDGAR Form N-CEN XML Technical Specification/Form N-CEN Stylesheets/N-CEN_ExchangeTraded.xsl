...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="authorizedParticipants">
		<table role="presentation">
			<tr>
				<td>
					Instructions: The term "authorized participant" means
					a
					broker-dealer that is
					also a member of a clearing agency registered
					with the Commission,
					and which has a written agreement with the
					Exchange-Traded Fund or
					Exchange-Traded Managed Fund or one of its
					designated service
					providers that allows it place orders to purchase
					or redeem
					creation units of the Exchange-Traded Fund or
					Exchange-Traded
					Managed Fund.
				</td>
			</tr>
	...
	<xsl:template name="creationUnits">
		...
		<table role="presentation">
			<tr>
				<td class="label">a. Number of Fund shares required to form a
					creation
