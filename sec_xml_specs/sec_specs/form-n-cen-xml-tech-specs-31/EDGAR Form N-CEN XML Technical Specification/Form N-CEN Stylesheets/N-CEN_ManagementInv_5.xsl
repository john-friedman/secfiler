...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="PartC">
		...
		<xsl:for-each
			...
			<xsl:if test="$icType = 'N-1A' or $icType = 'N-3'">
				...
				<xsl:call-template name="liquidityClassification" />
			</xsl:if>
		</xsl:for-each>
	</xsl:template>
						...
						<xsl:for-each select="m1:foreignInvestments/m1:foreignInvestment">
							...
							<tr>
								...
								<td>
									<p>
										<div class="fakeBox2">
											<xsl:value-of select="string(@foreignSubsidiaryRssdId)" />
											<span>
												<xsl:text>&#160;</xsl:text>
											</span>
										</div>
				...
				<tr>
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:securitiesAgentRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
								...
								<table role="presentation">
									...
									<tr>
										...
										<td>
											<p>
												<div class="fakeBox2">
													<xsl:value-of select="string(@idemnityProviderRssdId)" />
													<span>
														<xsl:text>&#160;</xsl:text>
													</span>
												</div>
			...
			<table role="presentation">
				...
				<tr>
					...
					<td>
						<p>
							<div class="fakeBox2">
								<xsl:value-of select="string(@collateralManagerRssdId)" />
								<span>
									<xsl:text>&#160;</xsl:text>
								</span>
							</div>
	...
	<xsl:template name="investmentAdvisers">
		...
		<!-- This following table is the mockup section just to display the empty 
			section when there is no value -->
		<xsl:choose>
			<xsl:when test="string(m1:investmentAdvisers/m1:investmentAdviser/m1:investmentAdviserName) = ''">
				<table role="presentation">
					<tr>
					...
					<tr>
						<td class="label">
							ii. SEC file number (<i>e.g., 801-</i>)
						</td>
						<td>
							<p>
								<div class="fakeBox2">
					...
					<tr>
						<td class="label">
							...
							indicate the investment adviser's start date:
						</td>
						<td>
							<p>
								<div class="fakeBox">
				...
				<xsl:for-each select="m1:investmentAdvisers/m1:investmentAdviser">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:investmentAdviserRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
					...
					<tr>
						<xsl:choose>
							<xsl:when
								...
								<tr>
									<td class="label">
										1. If the investment adviser was hired during the reporting
										period, indicate the investment adviser's start date:
									</td>
									<td>
										<p>
											<div class="fakeBox">
				...
				<xsl:for-each
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox">
									<xsl:value-of select="string(m1:investAdviserTerminatedRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
	...
	<!-- This following table is the mockup section just to display the empty 
			section when there is no value -->
	<xsl:choose>
		<xsl:when test="string(m1:subAdvisers/m1:subAdviser/m1:subAdviserName) = ''">
			<table role="presentation">
				<tr>
					<td class="label">i. Full name </td>
					<td>
				...
				<tr>
					<td class="label">
						ii. SEC file number (<i>e.g., 801-</i>), if applicable
					</td>
					<td>
						<p>
							<div class="fakeBox2">
				...
				<tr>
					<td class="label">
						vii. Is the sub-adviser an affiliated person of the Fund's investment adviser(s)?
					</td>
					<td>
						<xsl:call-template name="yesNoRadio">
							<xsl:with-param name="yesNoElement"
					...
					<tr>
						<td class="label">
							viii. Was the sub-adviser hired during the reporting period?
						</td>
						<td>
						<xsl:call-template name="yesNoRadio">
							<xsl:with-param name="yesNoElement"
				...
				<xsl:for-each select="m1:subAdvisers/m1:subAdviser">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:subAdviserRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
				...
				<xsl:for-each select="m1:subAdvisersTerminated/m1:subAdviserTerminated">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox">
									<xsl:value-of select="string(m1:subAdviserTerminatedRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
	...
	<xsl:choose>
		<xsl:when
			...
			<table role="presentation">
				...
				<tr>
					<td class="label">
						ii.SEC file number (<i>e.g., 84- or 85-</i>)
					</td>
					<td>
						<p>
							<div class="fakeBox2">
				...
				<tr>
					<td>iii. Identifying number(s)</td>
				</tr>
				<tr>
					<td class="label">LEI</td>
					<td>
				...
				<xsl:for-each select="m1:transferAgents/m1:transferAgent">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:transferAgentRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
	...
	<xsl:choose>
		<xsl:when
			...
			<table role="presentation">
				...
				<tr>
					<td class="label">Other identifying number</td>
					<td>
						<p>
							<div class="fakeBox3">
							</div>
			...
			<xsl:for-each select="m1:pricingServices/m1:pricingService">
				...
				<tr>
					...
					<td>
						<p>
							<div class="fakeBox">
								<xsl:value-of select="string(m1:pricingServiceRssdId)" />
								<span>
									<xsl:text>&#160;</xsl:text>
								</span>
							</div>
				...
				<tr>
					...
					<td>
						<p>
							<div class="fakeBox3">
								<xsl:value-of select="string(m1:pricingServiceOther)" />
								<span>
									<xsl:text>&#160;</xsl:text>
								</span>
							</div>
				...
				<xsl:for-each select="m1:custodians/m1:custodian">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:custodianRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
				...
				<xsl:for-each
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox3">
									<xsl:value-of select="string(m1:shareholderServiceAgentRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox3">
									<xsl:value-of select="string(m1:shareholderServiceAgentOther)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
				...
				<xsl:for-each select="m1:admins/m1:admin">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox3">
									<xsl:value-of select="string(m1:adminRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox3">
									<xsl:value-of select="string(m1:adminOther)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
				...
				<xsl:for-each select="m1:brokerDealers/m1:brokerDealer">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:brokerDealerRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox5">
									<xsl:call-template name="format_to_dollar_large">
										<xsl:with-param name="money" select="string(m1:brokerDealerCommission)" />
									</xsl:call-template>
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
				...
				<xsl:for-each select="m1:brokers/m1:broker">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:brokerRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
			...
			<tr>
				...
				<td>
					<p>
						<div class="fakeBox5">
						<xsl:call-template name="format_to_dollar_large">
						<xsl:with-param name="money" select="string(m1:aggregateCommission)" />
						</xsl:call-template>
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
				...
				<xsl:for-each select="m1:principalTransactions/m1:principalTransaction">
					...
					<tr>
						...
						<td>
							<p>
								<div class="fakeBox2">
									<xsl:value-of select="string(m1:principalRssdId)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
	...
	<!-- C.22 Section -->
	<xsl:template name="liquidityClassification">
		<table role="presentation">
			<tr>
				<td>a. Provide the following information about each person that provided liquidity classification services
		...
		<xsl:choose>
			<xsl:when test="m1:liquidityClassifications/m1:liquidityClassificationService">
				<table role="presentation">
					<xsl:for-each select="m1:liquidityClassifications/m1:liquidityClassificationService">
						<tr>
							<td>
								Liquidity Classification Record: <xsl:value-of select="position()"/>
							</td>
						</tr>
						<tr>
							<td class="label">i. Full name </td>
							<td>
								<div class="fakeBox3">
									<xsl:value-of select="string(m1:liquidityName)" />
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
								</div>
						...
						<tr>
							...
							<td>
								<p>
									<div class="fakeBox">
										<xsl:value-of select="string(m1:liquidityLei)" />
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
									</div>
						...
						<tr>
							...
							<td>
								<p>
									<div class="fakeBox">
										<xsl:value-of select="string(m1:liquidityRssdId)" />
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
									</div>
						...
						<tr>
							...
							<td>
								<p>
									<div class="fakeBox3">
										<xsl:value-of select="string(m1:liquidityOther)" />
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
									</div>
						...
						<tr>
							...
							<td>
								<p>
									<div class="fakeBox3">
										<xsl:value-of select="string(m1:otherDesc)" />
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
									</div>
						...
						<tr>
							...
							<td>
								<div class="fakeBox">
									<xsl:call-template name="stateDescription">
										<xsl:with-param name="stateCode"
										                select="string(m1:liquidityStateCountry/@liquidityState)" />
									</xsl:call-template>
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
						...
						<tr>
							...
							<td>
								<div class="fakeBox">
									<xsl:call-template name="condCountryDescription">
										<xsl:with-param name="code1"
										                select="m1:liquidityStateCountry/@liquidityCountry" />
										<xsl:with-param name="code2" select="m1:liquidityCountry" />
									</xsl:call-template>
									<span>
										<xsl:text>&#160;</xsl:text>
									</span>
						...
						<tr>
							<td class="label">
								v. Is the liquidity classification service an affiliated person of the Fund or its investment adviser(s)?
							</td>
							<td>
								<span class="yesNo">
									<xsl:choose>
										<xsl:when test="count(m1:isAffiliatedPerson) &gt; 0">
											<xsl:choose>
												<xsl:when test="string(m1:isAffiliatedPerson) = 'Y'">
													<img src="Images/radio-checked.jpg" alt="Radio button checked" />
													Yes
													<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
													No
											...
											<xsl:choose>
												<xsl:when test="string(m1:isAffiliatedPerson) = 'N'">
													<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
													Yes
													<img src="Images/radio-checked.jpg" alt="Radio button checked" />
													No
						...
						<tr>
							<td class="label">
								vi. Asset class(es) for which liquidity classification services were provided to the Fund (check all that apply)
							</td>
							<td>
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Short-term investment vehicle'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Repurchase agreement'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Equity-common'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Equity-preferred'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-commodity'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-credit'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-equity'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-foreign exchange'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-interest rate'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Derivative-other'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Structured note'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'ABS-mortgage backed security'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'ABS-asset backed commercial paper'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'ABS-collateralized bond/debt obligation'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'ABS-other'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Commodity'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
								...
								<xsl:choose>
									<xsl:when
											test="m1:assetClassType = 'Real estate'">
										<img src="Images/box-checked.jpg" alt="Checkbox checked" />
									</xsl:when>
									<xsl:otherwise>
										<img src="Images/box-unchecked.jpg" alt="Checkbox not checked" />
						...
						<tr>
							...
							<td>
								<p>
									<div class="fakeBox3">
										<xsl:value-of select="m1:otherAssetDesc" />
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
									</div>
			...
			<xsl:otherwise>
				<!-- This  table is the mockup section to display the empty section when there is no value -->
				<table role="presentation">
					<tr>
						<td class="label">i. Full name </td>
						<td>
		...
		<table role="presentation">
			<tr>
				...
				<td>
					<span class="yesNo">
						<xsl:choose>
							<xsl:when test="count(m1:isLiquidityHiredTerminated) &gt; 0">
								<xsl:choose>
									<xsl:when test="string(m1:isLiquidityHiredTerminated) = 'Y'">
										<img src="Images/radio-checked.jpg" alt="Radio button checked" />
										Yes
										<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
										No
								...
								<xsl:choose>
									<xsl:when test="string(m1:isLiquidityHiredTerminated) = 'N'">
										<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
										Yes
										<img src="Images/radio-checked.jpg" alt="Radio button checked" />
										No
