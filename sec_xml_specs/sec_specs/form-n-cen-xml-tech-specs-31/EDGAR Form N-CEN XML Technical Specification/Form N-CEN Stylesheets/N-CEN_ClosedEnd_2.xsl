...
<br />
						...
						<xsl:for-each	select="m1:closedEndManagementInvestment/m1:longTermDebtDefault/m1:longTermDebtDefaults/m1:longTermDebtDefault">
							...
							<tr>
								...
								<div class="fakeBox3">
									<xsl:call-template name="format_to_dollar_large">
										<xsl:with-param name="money"
											select="string(@defaultPerThousandAmount)" />
									</xsl:call-template>
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
							...
							<tr>
								...
								<div class="fakeBox3">
									<xsl:call-template name="format_to_dollar_large">
										<xsl:with-param name="money" select="string(@defaultTotalAmount)" />
										</xsl:call-template>
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
						...
						<xsl:for-each select="m1:closedEndManagementInvestment/m1:divdInArrears/m1:dividendsInArrears/m1:dividendsInArrear">
							...
							<tr>
								...
								<div class="fakeBox3">
									<xsl:call-template name="format_to_dollar_large">
										<xsl:with-param name="money"
											select="string(@dividendAmountPerShareInArrear)" />
										 </xsl:call-template>
										<span>
											<xsl:text>&#160;</xsl:text>
										</span>
		...
		<table role="presentation">	
			<tr>
				...
				<div class="fakeBox3">
					<xsl:call-template name="format_to_dollar_large">
						<xsl:with-param name="money"
						 select="m1:closedEndManagementInvestment/m1:managementFee" />
					 </xsl:call-template>
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
		...
		<table role="presentation">
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:smallInvestmentAdvisers/m1:smallInvestmentAdviser">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallInvestmentAdviserRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
		...
		<table role="presentation">
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:terminatedSmallInvAdvisers/m1:terminatedSmallInvAdviser">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallInvestmentAdviserTerminatedRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
		...
		<table role="presentation">
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:smallSubAdvisers/m1:smallSubAdviser">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallSubAdviserRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
				...
				<tr>
					...
					<td>
						<xsl:call-template name="yesNoRadio">
							<xsl:with-param name="yesNoElement" select="m1:isSmallSubAdviserAffiliated" />
						</xsl:call-template>
					</td>
				</tr>
		...
		<table role="presentation">
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:terminatedSmallSubAdvisers/m1:terminatedSmallSubAdviser">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallSubAdviserTerminatedRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
	...
	<xsl:template name="transferAgents">
		<table role="presentation">
			<tr>
				<td>a. Provide the following information about each person providing transfer agency services to the Fund:</td>
			</tr>
		</table>
		...
		<table role="presentation">	
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:smallTransferAgents/m1:smallTransferAgent">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallTransferAgentRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
         ...
         <table role="presentation">
			<xsl:for-each select="m1:closedEndManagementInvestment/m1:smallCustodians/m1:smallCustodian">
				...
				<tr>
					...
					<td>
						<div class="fakeBox2">
							<xsl:value-of select="string(m1:smallCustodianRssdId)" />
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
						</div>
				...
				<tr>
					...
					<td>
						<xsl:call-template name="yesNoRadio">
							<xsl:with-param name="yesNoElement" select="m1:isSmallCustodianAffiliated" />
						</xsl:call-template>
					</td>
				</tr>
				<tr>
						...
						<span class="yesNo">
							<xsl:choose>
								<xsl:when test="count(m1:custodyType) &gt; 0">
									<xsl:choose>
										<xsl:when test="string(m1:custodyType) = 'Bank - section 17(f)(1) (15 U.S.C. 80a-17(f)(1))'">
									...
									<xsl:choose>
										<xsl:when test="string(m1:custodyType) = 'Member national securities exchange - rule 17f-1 (17 CFR 270.17f-1)'">
											<img src="Images/radio-checked.jpg" alt="Radio button checked" />
											2.Member national securities exchange - rule 17f-1 (17 CFR 270.17f-1)<br/>
										</xsl:when>
										<xsl:otherwise>
											<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
											2.Member national securities exchange - rule 17f-1 (17 CFR 270.17f-1)<br/>
									...
									<xsl:choose>
										<xsl:when
											...
											<img src="Images/radio-checked.jpg" alt="Radio button checked" />
											6.Futures commission merchants and commodity clearing organizations - rule 17f-6 (17 CFR 270.17f-6)<br/>
										</xsl:when>
										<xsl:otherwise>
											<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
											6.Futures commission merchants and commodity clearing organizations - rule 17f-6 (17 CFR 270.17f-6)<br/>
									...
									<xsl:choose>
										<xsl:when
											...
											<img src="Images/radio-checked.jpg" alt="Radio button checked" />
											7.Foreign securities depository - rule 17f-7 (17 CFR 270.17f-7)<br/>
										</xsl:when>
										<xsl:otherwise>
											<img src="Images/radio-unchecked.jpg" alt="Radio button not checked" />
											7.Foreign securities depository - rule 17f-7 (17 CFR 270.17f-7)<br/>
