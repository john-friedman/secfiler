...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="numberOfContracts">
		<table role="presentation">
			...
			<tr>
				<td colspan="3">For each security that has a contract identification
			...
			<xsl:choose>
				<xsl:when test="string(m1:unitInvestmentTrust/m1:contractsInfos/m1:contractsInfo/@numOfContracts) = ''">
			<tr>
				<td class="label">Number of individual contracts that are in force at the end of the reporting period: </td>
				<td>
					<div class="fakeBox3">
					</div>
				</td>
			...
			<tr>
				<td class="label">Contract identification number:
				</td>
				<td>
					<div class="fakeBox3">
					</div>
			...
			<xsl:for-each select="m1:unitInvestmentTrust/m1:contractsInfos/m1:contractsInfo">
			<tr>
				<td colspan="3">
					Contacts Record:
					<xsl:value-of select="position()"></xsl:value-of>
			...
			<tr>
				...
				<td>
					<div class="fakeBox3">
						<xsl:value-of select="string(@numOfContracts)" />
						<span>
							<xsl:text>&#160;</xsl:text>
						</span>
					</div>
			...
			<tr>
				...
				<td>
					<div class="fakeBox3">
						<xsl:value-of select="string(@contractId)" />
						<span>
							<xsl:text>&#160;</xsl:text>
						</span>
					</div>
