...
xmlns:n1="http://www.sec.gov/edgar/common">
  ...
  <body class="fullwidth">
   <div class="content">
    <h2>FORM 13F INFORMATION TABLE</h2>
     ...
     <xsl:if test="count(ns1:informationTable/ns1:additionalHeaderInfo) &gt; 0">
	   Filer Name: <xsl:value-of select="ns1:informationTable/ns1:additionalHeaderInfo/ns1:institutionalInvestmentManagerName"/>
	   <br/>
	   Form 13F Filer Number: <xsl:value-of select="ns1:informationTable/ns1:additionalHeaderInfo/ns1:form13FFileNumber"/>
	   <br/>
	   Report for Calendar Quarter: <xsl:value-of select="ns1:informationTable/ns1:additionalHeaderInfo/ns1:reportCalendarOrQuarter"/>
	   <br/>
	   <br/>
    </xsl:if>
   <table border="0" class="infoTable" cellpadding="0" cellspacing="0">
    ...
    <xsl:for-each select="ns1:informationTable/ns1:infoTable">
    <tr>
		<xsl:choose>
			<xsl:when test="string-length(ns1:nameOfIssuer)!=0">
				<td valign="top" class="infoCol1">
					<xsl:value-of select="ns1:nameOfIssuer"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:titleOfClass)!=0">
				<td valign="top" class="infoCol2">
					<xsl:value-of select="ns1:titleOfClass"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:cusip)!=0">
				<td valign="top" class="infoCol5a">
					<xsl:value-of select="ns1:cusip"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:figi)!=0">
				<td valign="top" class="infoCol5c">
					<xsl:value-of select="ns1:figi"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:value)!=0">
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:shrsOrPrnAmt/ns1:sshPrnamt)!=0">
				<td valign="top" class="infoCol5a">
					<xsl:value-of select="ns1:shrsOrPrnAmt/ns1:sshPrnamt"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
				<td valign="top" class="infoCol5a">-</td>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:shrsOrPrnAmt/ns1:sshPrnamtType)!=0">
				<td valign="top" class="infoCol5b">
					<xsl:value-of select="ns1:shrsOrPrnAmt/ns1:sshPrnamtType"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:putCall)!=0">
				<td valign="top" class="infoCol5c">
					<xsl:value-of select="ns1:putCall"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
				<td valign="top" class="infoCol5c">-</td>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:investmentDiscretion)!=0">
				<td valign="top" class="infoCol6">
					<xsl:value-of select="ns1:investmentDiscretion"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:otherManager)!=0">
				<td valign="top" class="infoCol7">
					<xsl:value-of select="ns1:otherManager"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:votingAuthority/ns1:Sole)!=0">
				<td valign="top" class="infoCol8a">
					<xsl:value-of select="ns1:votingAuthority/ns1:Sole"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:votingAuthority/ns1:Shared)!=0">
				<td valign="top" class="infoCol8b">
					<xsl:value-of select="ns1:votingAuthority/ns1:Shared"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
		...
		<xsl:choose>
			<xsl:when test="string-length(ns1:votingAuthority/ns1:None)!=0">
				<td valign="top" class="infoCol8c">
					<xsl:value-of select="ns1:votingAuthority/ns1:None"/>
				</td>
			</xsl:when>
			<xsl:otherwise>
