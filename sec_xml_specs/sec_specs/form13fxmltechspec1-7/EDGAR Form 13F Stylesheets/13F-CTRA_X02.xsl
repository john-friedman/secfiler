    ...
    <xsl:template match="/">
        ...
        <html>
           <head>
                ...
                <link rel="stylesheet" type="text/css" href="css/13F_print.css" />
            ...
            <body>
                <xsl:for-each select="$USER">
                            ...
                            <table role="presentation" class="formTable">
                                ...
                                <tbody>
                                        ...
                                        <td class="yesNo" nowrap="0">
                                            <xsl:choose>
                                                <xsl:when test="$XML/n1:edgarSubmission/n1:headerData/n1:filerInfo/n1:liveTestFlag=&quot;LIVE&quot;">
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\radio-checked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
                                                            </xsl:if>
                                                            <xsl:value-of select="translate(string(&apos;\AR\Images\radio-checked.jpg&apos;), '&#x5c;', '/')"/>
                                                        </xsl:attribute>
                                                ...
                                                <xsl:when test="$XML/n1:edgarSubmission/n1:headerData/n1:filerInfo/n1:liveTestFlag=&quot;TEST&quot;">
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\radio-unchecked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
                                                            </xsl:if>
                                                            <xsl:value-of select="translate(string(&apos;\AR\Images\radio-unchecked.jpg&apos;), '&#x5c;', '/')"/>
                                                        </xsl:attribute>
                                        ...
                                        <td class="yesNo" nowrap="0">
                                            <xsl:choose>
                                                <xsl:when test="$XML/n1:edgarSubmission/n1:headerData/n1:filerInfo/n1:flags/n1:confirmingCopyFlag=&quot;true&quot;">
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\box-checked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
                                                            </xsl:if>
                                                            <xsl:value-of select="translate(string(&apos;\AR\Images\box-checked.jpg&apos;), '&#x5c;', '/')"/>
                                                        </xsl:attribute>
                                                ...
                                                <xsl:otherwise>
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\box-unchecked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
                                                            </xsl:if>
                                                            <xsl:value-of select="translate(string(&apos;\AR\Images\box-unchecked.jpg&apos;), '&#x5c;', '/')"/>
                                                        </xsl:attribute>
                                    ...
                                    <tr>
                                        <td nowrap="0">
                                            <span>
                                                <xsl:text>Is this a de novo request? (Please select one. Refer to Confidential Treatment Instruction 2.g.) </xsl:text>
                                            </span>
                                        </td>
                                        <td class="yesNo" nowrap="0">
                                            <span>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$XML/n1:edgarSubmission/n1:headerData/n1:filerInfo/n1:denovoRequest=&quot;Y&quot;">
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\radio-checked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$XML/n1:edgarSubmission/n1:headerData/n1:filerInfo/n1:denovoRequest=&quot;N&quot;">
                                                    <img>
                                                        <xsl:attribute name="src">
                                                            <xsl:if test="substring(string(&apos;\AR\Images\radio-checked.jpg&apos;), 2, 1) = ':'">
                                                                <xsl:text>file:///</xsl:text>
																	...
																	<xsl:for-each select="n1:otherManager">
																	 <tr>
																		...
																		<td nowrap="0" valign="top">
																			...
																			<td nowrap="0" valign="top">
																			  <xsl:choose>
																						<xsl:when test="n1:secFileNumber != &quot;&quot;">
																			  <xsl:for-each select="n1:secFileNumber">
																							 <div class="fakeBox">
																								<xsl:apply-templates/>
																							</div>
                    ...
                    <xsl:if test="$XML/n1:edgarSubmission/n1:headerData/n1:submissionType=&quot;13F-HR&quot; or $XML/n1:edgarSubmission/n1:headerData/n1:submissionType=&quot;13F-HR/A&quot; or $XML/n1:edgarSubmission/n1:headerData/n1:submissionType=&quot;13F-CTR&quot; or $XML/n1:edgarSubmission/n1:headerData/n1:submissionType=&quot;13F-CTR/A&quot;">
                    <div class="content pageBreak">
                        <h2>
                            <span>
                                                                                    ...
                                                                                    <xsl:for-each select="n1:otherManagers2Info">
                                                                                        <xsl:for-each select="n1:otherManager2">
																						 <tr>
																						   ...
																						   <td nowrap="0" valign="top">
																							  <xsl:choose>
																										<xsl:when test="n1:otherManager/n1:crdNumber != &quot;&quot;">
																							<xsl:for-each select="n1:otherManager">
                                                                                                <xsl:for-each select="n1:crdNumber">
                                                                                                    	 <div class="fakeBox">
																												<xsl:apply-templates/>
                                                                                 		     ...
                                                                                 		     <td nowrap="0" valign="top">
																							  <xsl:choose>
																										<xsl:when test="n1:otherManager/n1:secFileNumber != &quot;&quot;">
																							<xsl:for-each select="n1:otherManager">
                                                                                                <xsl:for-each select="n1:secFileNumber">
                                                                                                    	 <div class="fakeBox">
																												<xsl:apply-templates/>
